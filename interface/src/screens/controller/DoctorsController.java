...
public class DoctorsController implements InitializingController {
  ...
  private void renderSpecialityField() {
    speciality.setCellFactory(param ->
      new ListCell<>() {
        @Override
    ...
    specialityCol.setCellFactory(param ->
      new TableCell<Doctor, Speciality>() {
        @Override
        protected void updateItem(Speciality item, boolean empty) {
          super.updateItem(item, empty);
  ...
  public void setCellValueFactory() {
    codeCol.setCellValueFactory(
      new PropertyValueFactory<Doctor, IntegerProperty>("code")
    );
    nameCol.setCellValueFactory(
      new PropertyValueFactory<Doctor, String>("name")
    );
    crmCol.setCellValueFactory(
      new PropertyValueFactory<Doctor, String>("identifier")
    );
    specialityCol.setCellValueFactory(
      new PropertyValueFactory<Doctor, Speciality>("speciality")
    );
    roomCol.setCellValueFactory(
      new PropertyValueFactory<Doctor, String>("attendenceRoom")
    );
    contactCol.setCellValueFactory(
      new PropertyValueFactory<Doctor, String>("phoneNumber")
    );
    statusCol.setCellValueFactory(
      new PropertyValueFactory<Doctor, String>("status")
    );
  }
    ...
    if (medicoSelecionado != null) {
      ...
      if (medicoEstaNaConsulta) {
        ...
        alert.setContentText(
          "O médico está em uma consulta. Não é possível remover."
        );
        alert.showAndWait();
      } else {
        int specialityInfo = medicoSelecionado
          .getSpeciality()
          .getDoctorsAmount();
