...
public class Doctor extends Person {
    ...
    public Doctor(
        ...
        super(++instanceDoctorCount, name, identifier, dateOfBirth, phoneNumber, email, gender);
    ...
    public Doctor(
        ...
        super(++instanceDoctorCount, name, identifier, dateOfBirth, phoneNumber, email, "Não identificado");
        this.speciality = speciality;
        this.status = status;
        this.attendenceRoom = attendenceRoom;
    }
